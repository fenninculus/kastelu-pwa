  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Kastelu',
        short_name: 'Kastelu',
        description: 'Houseplant care tracker',
        display: 'standalone',
        theme_color: '#EDF1EA',
        ...
        icons: [
          ...
          // the plain icon keeps the macOS icon's rounded white corners, which a
          // square mask would expose — this one is cropped to full-bleed pine
